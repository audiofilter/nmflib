function [W,H,errs,vout] = nmf_euc(V, r, varargin)
% function [W,H,errs,vout] = nmf_euc(V, r, varargin)
%
% Implements NMF using squared error cost function (see [1] for details):
% 
...
for t = 1:niter
    ...
    if verb >= 3
        disp(['nmf_euc: iter=' num2str(t) ', err=' num2str(errs(t))]);
    end
